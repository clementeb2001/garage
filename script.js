...
(function () {
  ...
  var I18N = {
    lb: {
      ...
      hero_b2_v: 'Tuning', hero_b2_l: '& Motorsport',
      hero_b3_v: '1·2·3 AutoService', hero_b3_l: 'Partnernetzwierk',
      trust1: '1·2·3 AutoService Partnergarage', trust2: 'Tuning & Motorsport',
      trust3: 'Reifenservice an Alagerung', trust4: 'Nëmme mat Rendez-vous',
      partner_strip: 'An Zesummenaarbecht mat',
      tuning_eyebrow: 'Tuning & Motorsport', tuning_title: 'Méi wéi Serie – Tuning no Mooss',
      tuning_lead: 'Egal ob Rallye- oder Rennstreckevirbereedung, Tieferleeung oder Karrosseriearbechten – mir bréngen Äre Won op dat nächst Niveau.',
      tuning_1_t: 'Rallye & Rennstreck', tuning_1_d: 'Komplett Virbereedung fir Rallye an Trackdays – Setup, Sécherheet a Performance.',
      tuning_2_t: 'Tieferleeung & Fahrwierk', tuning_2_d: 'Gewindefahrwierker, Sportfederen an Ausriichtung fir e sportlecht Fahrgefill.',
      tuning_3_t: 'Karrosserie & Optik', tuning_3_d: 'Spoiler, Verbreederungen, Reparaturen a Lackéierung – propper ëmgesat.',
    ...
    de: {
      ...
      trust1: '1·2·3 AutoService Partnerbetrieb', trust2: 'Tuning & Motorsport',
      trust3: 'Reifenservice & Einlagerung', trust4: 'Nur nach Terminvereinbarung',
      partner_strip: 'In Zusammenarbeit mit',
      tuning_eyebrow: 'Tuning & Motorsport', tuning_title: 'Mehr als Serie – Tuning nach Maß',
      tuning_lead: 'Ob Rallye- oder Rennstreckenvorbereitung, Tieferlegung oder Karosseriearbeiten – wir bringen Ihr Fahrzeug auf das nächste Level.',
      tuning_1_t: 'Rallye & Rennstrecke', tuning_1_d: 'Komplette Vorbereitung für Rallye und Trackdays – Setup, Sicherheit und Performance.',
      tuning_2_t: 'Tieferlegung & Fahrwerk', tuning_2_d: 'Gewindefahrwerke, Sportfedern und Achsvermessung für ein sportliches Fahrgefühl.',
      tuning_3_t: 'Karosserie & Optik', tuning_3_d: 'Spoiler, Verbreiterungen, Reparaturen und Lackierung – sauber umgesetzt.',
    ...
    fr: {
      ...
      hero_b2_v: 'Tuning', hero_b2_l: '& sport auto',
      hero_b3_v: '1·2·3 AutoService', hero_b3_l: 'Réseau partenaire',
      trust1: 'Garage partenaire 1·2·3 AutoService', trust2: 'Tuning & sport auto',
      trust3: 'Service pneus & stockage', trust4: 'Sur rendez-vous',
      partner_strip: 'En collaboration avec',
      tuning_eyebrow: 'Tuning & sport auto', tuning_title: 'Au-delà de la série – tuning sur mesure',
      tuning_lead: 'Préparation rallye ou circuit, rabaissement ou travaux de carrosserie – nous emmenons votre véhicule au niveau supérieur.',
      tuning_1_t: 'Rallye & circuit', tuning_1_d: 'Préparation complète pour rallye et trackdays – réglages, sécurité et performance.',
      tuning_2_t: 'Rabaissement & châssis', tuning_2_d: 'Combinés filetés, ressorts sport et géométrie pour un comportement sportif.',
      tuning_3_t: 'Carrosserie & look', tuning_3_d: 'Ailerons, élargisseurs, réparations et peinture – réalisés proprement.',
    ...
    en: {
      ...
      trust1: '1·2·3 AutoService partner garage', trust2: 'Tuning & motorsport',
      trust3: 'Tyre service & storage', trust4: 'By appointment',
      partner_strip: 'In collaboration with',
      tuning_eyebrow: 'Tuning & motorsport', tuning_title: 'Beyond standard – bespoke tuning',
      tuning_lead: 'Whether rally or race-track preparation, lowering or bodywork – we take your vehicle to the next level.',
      tuning_1_t: 'Rally & race track', tuning_1_d: 'Full preparation for rally and track days – setup, safety and performance.',
      tuning_2_t: 'Lowering & suspension', tuning_2_d: 'Coilovers, sport springs and alignment for a sporty feel.',
      tuning_3_t: 'Bodywork & styling', tuning_3_d: 'Spoilers, widenings, repairs and paintwork – cleanly executed.',
